...
\title{\boldmath Lit review and other on M1 internship. }
...
\abstract{So far this article will containg review of papers i went throgh for my m1 internship.}
...
\label{sec:intro}
I can try citeing \cite{PhysRevLett.126.051102}
...
% [A] Recommende/d: using JHEP.bst file
